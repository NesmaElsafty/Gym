                                ...
                                <div class="card-body">
                                    <form action="userAction.php" method="post" enctype="multipart/form-data"> 
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                                <label for="validationCustom04">phase</label>
                                                <input type="number" class="form-control" name="phase" id="validationCustom04" placeholder="phase" value="<?php echo !empty($rows['phase'])?$rows['phase']:''; ?>" required>
