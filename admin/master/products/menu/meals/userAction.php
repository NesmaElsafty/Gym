...
if ($RM > 0 && isset($_POST['add'])) {
	...
	$carbs = $_POST['carbs'];
		...
		$sql = "INSERT INTO packages (type,name,price,meal_description,meal_name,fats ,calories,protein,carbs) 
				VALUES ('".$type."','".$name."','".$price."','".$meal_description."','".$meal_name."','".$fats."','".$calories."','".$protein."','".$carbs."')";
